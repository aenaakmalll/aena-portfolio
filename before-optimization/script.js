...
if (lightbox) {
  ...
  // Matches thumbnail buttons across all case-study pages:
  // .gallery-item (Zen/ShehNoor original pages), plus
  // .newsletter-item and .post-item (new multi-section pages)
  document.querySelectorAll('.gallery-item, .newsletter-item, .post-item').forEach(item => {
